...
\begin{frame}{Empirical framework}
  \begin{itemize}
    \item \highlight{Unit:} enterprise--application or enterprise--programme observation
    \item \highlight{Population:} SMEs applying or eligible for innovation support
    \item \highlight{Variation:} scoring rules, thresholds, grant amounts, programme design
    \item \highlight{Comparison:} firms close to allocation margins, or comparable firms over time
  \end{itemize}

  \vspace{0.4cm}

  The empirical design depends on data access, but the estimand must stay narrow.
\end{frame}
