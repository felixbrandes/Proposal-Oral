...
\begin{frame}{Master’s thesis}
  ...
  \normalsize
  \begin{itemize}
    \item analysed convertible loans as a start-up financing instrument
    \item reviewed legal, financial, and contractual requirements
    \item compared contract templates and standard clauses
