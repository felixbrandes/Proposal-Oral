...
\begin{frame}{Theoretical Framework}
  ...
  \vspace{0.5ex}
  \begin{itemize}
    \item[\color{accent}1.] \textbf{Identify the selection rule} --- code programme documents, scoring rubrics and eligibility criteria; recover implied signal weights; compare stated vs.\ applied weights
    \item[\color{accent}2.] \textbf{Estimate causal effects} --- regression-discontinuity around score / budget cut-offs; applicants just above and below the threshold are otherwise comparable
  \end{itemize}
  \vspace{0.8ex}
